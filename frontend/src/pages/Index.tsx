...
const Index: React.FC = () => {
  ...
  debounce(async () => {
    ...
    // Prepare payload with session_id if available
    let sessionToSend = sessionId;
    const payload: any = {
      query: inputText,
      session_id: sessionToSend || undefined,
    };
    ...
    try {
      ...
      // Always update sessionId after first response
      ...
      addMessage(
        ...
        false,
        data.references || [],
        data.query_type || 'general_inquiry',
        data.format_used || 'text',
